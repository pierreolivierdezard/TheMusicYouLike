                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group{{ $errors->has('profileImage') ? ' has-error' : '' }}">
                            <label for="birthDate" class="col-md-4 control-label">Profile Image</label>

                            <div class="col-md-6">
                                <input id="profileImage" type="file" class="form-control" name="profileImage" value="{{ old('profileImage') }}" required autofocus>
